...
function StudentModel(asyncIndicator) {
    ...
    this.GetEnrollments = function (id, callback) {
        var url = "http://localhost:9393/Api/Student/GetEnrollments?studentId=" + id;
        ...
        $.ajax({
            ...
            error: function () {
                alert('Error while loading transcript.  Is your service layer running?');
            }
        });
    };
}
